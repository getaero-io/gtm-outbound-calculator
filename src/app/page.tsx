            ...
            >
              ...
              <svg className="h-6" viewBox="0 0 120 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g className="group-hover:opacity-80 transition-opacity">
                  <path d="M8 4h8c2.21 0 4 1.79 4 4v8c0 2.21-1.79 4-4 4H8c-2.21 0-4-1.79-4-4V8c0-2.21 1.79-4 4-4z" fill="currentColor" className="text-blue-600"/>
                  <path d="M12 8v8m-2-6h4" stroke="white" strokeWidth="2" strokeLinecap="round"/>
                  <text x="28" y="16" className="fill-current" style={{fontSize: '14px', fontWeight: 600, fontFamily: 'system-ui, -apple-system, sans-serif'}}>Deepline</text>
                </g>
              </svg>
            </a>
          </div>
